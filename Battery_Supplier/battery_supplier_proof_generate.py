...
model_path = os.path.join("models", "battery_verification_model.onnx")
...
pk_path = os.path.join("zkml_data", "test.pk")
vk_path = os.path.join("zkml_data", "test.vk")

proof_path = os.path.join("zkml_data", "test.pf")
...
async def run_zkml_pipeline():
    print("🚀 Starting ZKML Pipeline for Battery Supplier...\n")
    ...
    # 3. Compile Circuit
    # -----------------------------
    print("🛠️ Compiling battery verification circuit...")
