...
model_path = os.path.join("models", "motor_verification_model.onnx")
data_path = os.path.join("models", "input_motor.json")

settings_path = os.path.join("zkml_data_motor", "settings.json")
compiled_model_path = os.path.join("zkml_data_motor", "network.compiled")

pk_path = os.path.join("zkml_data_motor", "test.pk")
vk_path = os.path.join("zkml_data_motor", "test.vk")

proof_path = os.path.join("zkml_data_motor", "test.pf")
witness_path = os.path.join("zkml_data_motor", "witness.json")

srs_path = os.path.join("zkml_data_motor", "kzg.srs")
...
async def run_zkml_pipeline():
    print("🚀 Starting ZKML Pipeline for Motor Supplier...\n")
    ...
    # 3. Compile Circuit
    # -----------------------------
    print("🛠️ Compiling motor verification circuit...")
